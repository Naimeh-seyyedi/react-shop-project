import { Box, Button, Card, CardActions, CardContent, CardMedia, CircularProgress, Container, CssBaseline, Grid, Pagination, Typography } from "@mui/material";
...
function FirstProductGroup() {
  ...
  const { data, loading } = useFetch(
    `products?sub_category_id=8&sub_category_id=7&_limit=${limit.current}`
  );
  ...
  return (
    <React.Fragment>
      ...
      {loading ? (
        ...
        <Grid container spacing={2} sx={{padding:2}} className="main-container">
